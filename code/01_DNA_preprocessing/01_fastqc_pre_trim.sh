...
#SBATCH --mail-user=maja.nettelbladt.9823@student.uu.se  # E-post vid jobbet$
...
OUTPUT_DIR="/home/mane9823/Genome-Analysis/analyses/DNA_analyses/01_preprocessing/fastqc_raw
